            ...
            <div className="container mx-auto py-10">
                <Tabs defaultValue="all" className="w-full">
                    ...
                    <TabsContent value="all">
                        <DataTable searchKey='customer_name' columns={columns} data={AllData} />
                    </TabsContent>
                    <TabsContent value="subscribed">
                        <DataTable searchKey='customer_name' columns={columns} data={Subscribeddata} />
                    </TabsContent>
                    <TabsContent value="non-subscribed">
                        <DataTable searchKey='customer_name' columns={columns} data={NonSubscribeddata} />
